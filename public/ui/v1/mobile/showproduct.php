		...
		<ul class="am-slides my-simple-gallery am-gallery" data-am-widget="gallery" data-am-gallery="{pureview: 1}">
			<li>
				<div class="am-gallery-item">
					<img src="{$product[imgurl]}" data-rel="{$product[imgurl]}" width = '100%' alt="{$product[title]}" />
...
-->
			<li>
				<div class="am-gallery-item">
				<img src="{$val[imgurl]}" data-rel="{$val[imgurl]}" alt="{$val[title]}" />
...
-->
	...
	<ul class="met_related_list" style = 'display:none;'>
<!--
EOT;
$i=0;
