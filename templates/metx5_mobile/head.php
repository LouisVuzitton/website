...
<body>
    <header {$topgu}>
		<section>
			<div class="tem_top" style = 'background:#fff;'>
<!--
EOT;
...
echo <<<EOT
-->
				<i class="am-icon-bars" style ='color:#999'></i>
			</div>
		</section>
		<div class="tem_head">
			<div class="tem_langlist am-collapse">
				<ul style = 'background:#fff;color:black;'>
...
echo <<<EOT
-->
					<li style = 'background:#fff;color:black;'><a href="{$val[met_weburl]}" title="{$val[name]}" {$met_now}>{$val[name]}</a></li>
<!--
EOT;
}
}
...
<ul>
	<li style = 'background:#fff;color:black;' ><a  style = 'color:black;'href="{$index_url}" title="{$lang_home}" {$navnow}>{$lang_home}</a></li>
<!--
EOT;
...
echo <<<EOT
-->
	<li style = 'background:#fff;color:black;'>
		<a style = 'color:black;' href="{$val[url]}" {$val[new_windows]} title="{$val[name]}" {$navnow}>{$val[name]}</a>
	</li>
<!--
EOT;
}
...
-->
			<li>
				<a href="{$val[img_link]}" title="{$val[img_title]}"><img src="{$val[img_path]}" alt="{$val[img_title]}" style = 'height:auto;'/></a>
			</li>
<!--
EOT;
}
