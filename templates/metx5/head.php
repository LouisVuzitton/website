    ...
    <header data-waypointsok="{$lang_waypointsok}">
		<section style = 'display:none;> 
			<div class="tem_inner tem_top">
				<h2>{$met_seo}</h2>
				<div class="tem_top_nav" style = 'display:none;'>
<!--
EOT;
...
-->
			<h{$h}>
				<a href="{$index_url}" title="{$met_webname}">
					<img src="{$met_logo}" alt="{$met_webname}" style="margin:{$lang_LogoTop}px 0px 0px {$lang_LogoLeft}px;" title="{$met_webname}" width = '20%' />
				</a>
			</h{$h}>
<!--
EOT;
